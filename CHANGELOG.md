...
- Исправлена конфигурация Vercel - удалено недопустимое свойство cwd и возвращен outputDirectory: "apps/web/.next"
- Исправлены команды в vercel.json - добавлен префикс pnpm для корректного запуска turbo
